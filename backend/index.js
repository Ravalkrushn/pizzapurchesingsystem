...
app.post("/rest_add_pizza", upload.single('image'), async function (req, res) {
    ...
    let ob1 = new Pizza({ pizza_id: parseInt(newpizzaid), pizza_name: req.body.name, description: req.body.desc,price: parseInt(req.body.price), pizza_img: filepath,res_id: parseInt(req.body.restid) });
...
app.post("/rest_update_pizza_withimg", upload.single('image'), async function (req, res) {
    let result2 = await Pizza.updateOne({ pizza_id: parseInt(req.body.pizzaid)},{$set:{ pizza_name: req.body.name, description: req.body.desc,price: parseInt(req.body.price), pizza_img: filepath,res_id: parseInt(req.body.restid) }});
    res.send(result2);
})

app.post("/rest_update_pizza", async function (req, res) {
    let result2 = await Pizza.updateOne({ pizza_id: parseInt(req.body.pizzaid)},{$set:{ pizza_name: req.body.name, description: req.body.desc,price: parseInt(req.body.price),res_id: parseInt(req.body.restid) }});
    res.send(result2);
})
